<form method="POST" action="{{ route('parameters.commercial-origins.update', $commercialOrigin) }}" data-ajax-form data-refresh-url="{{ route('parameters.commercial-origins.index') }}" novalidate>
    @csrf @method('PUT')
