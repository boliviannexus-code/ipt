...
@section('title', 'Detalle producto | Inventario POS')
@section('page-title', 'Detalle producto')
@section('page-subtitle', 'Consulta de informacion del producto')
    ...
    <x-ui.card title="Informacion del producto">
        <div class="card-body">
            ...
            <dl class="row mb-0">
                ...
                <dd class="col-sm-9">{{ $product->is_active ? 'Activo' : 'Inactivo' }}</dd>
            </dl>
        </div>
