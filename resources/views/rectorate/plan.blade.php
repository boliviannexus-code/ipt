...
@section('content')
    <div class="rectorate-wizard">
        <div class="rectorate-wizard__intro">
            <div><span class="rectorate-wizard__eyebrow">Cuenta {{ $application->account_number }} · Inscripción #{{ $application->id }}</span><h2>Programa y plan</h2></div>
