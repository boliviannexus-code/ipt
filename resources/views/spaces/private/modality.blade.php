...
@section('content')
    ...
    <form method="POST" action="{{ route('spaces.private.modality.store') }}" data-ajax-form novalidate>
        @csrf
        <div class="row g-3">
            <div class="col-lg-6">
                <label class="form-selectgroup-item flex-fill">
                    <input class="form-selectgroup-input" name="space_mode" type="radio" value="privado" checked>
            ...
            <div class="col-lg-6">
                <a class="form-selectgroup-item flex-fill text-decoration-none" href="{{ route('spaces.shared.create') }}">
                    <div class="form-selectgroup-label d-flex align-items-start p-3">
                        <span class="me-3"><i class="ti ti-building-community fs-1 text-secondary"></i></span>
                        <span>
                            <span class="d-block fw-semibold">Compartido</span>
                            <span class="d-block text-body-secondary">Para hoteles, hostales, residencias y habitaciones independientes.</span>
                        </span>
                    </div>
                </a>
            </div>
