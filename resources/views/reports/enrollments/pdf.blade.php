...
<table border="1" cellpadding="3" cellspacing="0" width="100%" style="font-size:6.5px;"><thead><tr style="background-color:#183153;color:#ffffff;font-weight:bold;"><th width="7%">Fecha</th><th width="10%">Cuenta / Sede</th><th width="15%">Estudiante / CI</th><th width="15%">Programa / Plan</th><th width="13%">Ejecutivo</th><th width="10%">Origen</th><th width="9%">Cargos</th><th width="9%">Recaudado</th><th width="7%">Saldo</th><th width="5%">Estado</th></tr></thead><tbody>
