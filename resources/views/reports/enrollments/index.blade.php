...
@section('content')
    ...
    <x-ui.table-card title="Resultados">
        <div class="table-responsive"><table class="table table-hover align-middle mb-0"><thead><tr><th>Fecha</th><th>Cuenta / Sede</th><th>Estudiante</th><th>Programa / Plan</th><th>Ejecutivo</th><th>Origen</th><th class="text-end">Cargos</th><th class="text-end">Recaudado</th><th class="text-end">Saldo</th><th>Estado</th></tr></thead><tbody>
